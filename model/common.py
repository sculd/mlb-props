...
Hit_Real_Features = ["pitching_gamesPlayed","pitching_runs", "pitching_strikeOuts", "pitching_hits","pitching_id", 
                     "batting_gamesPlayed", "batting_runs","batting_strikeOuts", "batting_hits","batting_rbi", "batting_hit_recorded",
                     "batting_id", "temp", "game_venue", "game_year"] + ["batting_name", "pitching_name"]
